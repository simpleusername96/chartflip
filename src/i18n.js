  ...
  const TEXT = {
    ko: {
      ...
      helpSteps: [
        ...
        ['땅에서 꾹', '부스트를 누르는 동안 게이지를 쓰며 가속해요. 바퀴로 밀기 때문에 공중에선 헛돌아요.']
      ],
      keys: '스페이스 뒤집기 · X 꾹 부스트 · R 다시 · Esc 일시정지',
      dataNote: '모든 코스는 게임을 위해 만든 가상 차트예요. 실제 시세가 아니에요.',
      seconds: '초',
      canvas: '차트플립 게임 화면',
    ...
    en: {
      ...
      soundOn: 'Sound on',
      soundOff: 'Sound off',
      guideOn: 'Bottom guide on',
      guideOff: 'Bottom guide off',
      guide: 'Bottom guide',
      help: 'How to play',
      close: 'Got it',
      helpSteps: [
        ...
        ['Hold it on the ground', 'Holding boost burns the gauge for speed. It drives the wheels, so in the air it just spins.']
      ],
      keys: 'Space flip · hold X boost · R retry · Esc pause',
      dataNote: 'All courses use fictional charts made for the game. They are not market prices.',
      seconds: 's',
